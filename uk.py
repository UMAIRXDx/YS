...
for xd in range(10000):
	a='Mozilla/5.0 (SymbianOS/9.4; Series60/5.0'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='Nokia520/50.1.001;'
	e=random.randrange(100, 9999)
	f='Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/533.4 (KHTML, like Gecko) NokiaBrowser/7.3.1.25'
	...
	c='moto g(10) power Build/RRBS31.Q1-3-34-1-2; wv)'
...
for x in range(10):
	...
	i='REALME RMX1911 Build/NMF26F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.111'
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 11; RMX2002 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/94.0.4606.85 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/331.1.0.29.117;]'
